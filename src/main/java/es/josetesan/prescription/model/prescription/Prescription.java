...
public record Prescription(
    ...
    GTin gtin,
    @XmlElement(name = "formasfarmaceuticas") FormasFarmaceuticas formasFarmaceuticas,
    Atc atc,
    @XmlElement(name = "problemassuministro") ProblemasSuministro problemassuministro,
    Imagenes imagenes,
